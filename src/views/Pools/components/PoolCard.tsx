...
import { Button, IconButton, useModal, AddIcon, Image } from '@lysfinance-dev/uikit'
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  return (
    <StyledPoolCard isActive={isCardActive} isFinished={isFinished && sousId !== 0} style={{ borderRadius: 8 }}>
      ...
      <div style={{ padding: '24px' }}>
        ...
        <RewardsWrapper>
          ...
          <Divider />
          <div style={{ justifyContent: 'space-between', display: 'flex', width: '100%', padding: 13, paddingTop: 20 }}>
...
const EarnedLebelStyled = styled.div`
  opacity: 0.5;
  > div {
    font-size: 14px;
  }
